...
<script src="{{ asset('client/https://code.jquery.com/jquery-3.4.1.min.js') }} "></script>
<script src="{{ asset('client/https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.bundle.min.js') }} "></script>
